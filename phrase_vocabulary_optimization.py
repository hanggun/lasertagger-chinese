...
flags.DEFINE_string(
    ...
    'documentation).')
flags.DEFINE_enum(
    'input_format', 'csl', ['wikisplit', 'discofuse', 'sfzy', 'csl'],
...
flags.DEFINE_integer(
    ...
    'the vocabulary.')
flags.DEFINE_string(
    'output_file', 'data/csl_10k/label_map.txt',
...
flags.DEFINE_integer('vocabulary_size', 5000,
...
def _added_token_counts(data_iterator, try_swapping, max_input_examples=10000):
  ...
  num_examples = 0
  all_added_phrases = []
  for sources, target in tqdm(data_iterator):
